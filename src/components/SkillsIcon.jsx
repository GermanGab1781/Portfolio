...
const SkillsIcon = ({name, img}) => {
  return (
      <div className="relative m-auto group mb-8">
        ...
        <span className="absolute opacity-0 group-hover:opacity-100 transition-all delay-100 text-2xl -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-black dark:text-white">{name}</span>
      </div>
  );
}
